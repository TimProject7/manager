			...
			function() {
				$("#regBtn").click(function() {
					...
					if (productName == "") {
						...
						// 폼 내부의 데이터를 전송할 주소
						document.form.action = "/admin/product/productreg"
						// 제출
		...
		<table border="1">
			...
			<tr>
				...
				<td colspan="3"><input type="text" id="product_name"
					name="product_name" value="${productEdit.product_name }">
			...
			<tr>
				...
				<td colspan="3"><input type="number" id="product_price"
					name="product_price" value="${productEdit.product_price }"></td>
			</tr>
			<tr>
				<th>제조사</th>
			...
			<tr>
				...
				<td colspan="3"><textarea id="product_content"
						name="product_content">${productEdit.product_content }</textarea></td>
			</tr>
		</table>
